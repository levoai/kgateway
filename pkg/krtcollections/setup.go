...
// 	gatewayForDeployerTransformationFunc func(kctx krt.HandlerContext, gw *gwv1.Gateway, igw *ir.GatewayForDeployer) *ir.GatewayForDeployer,
// 	gatewayForEnvoyTransformationFunc func(kctx krt.HandlerContext, gw *gwv1.Gateway, igw *ir.Gateway) *ir.Gateway,
...
// 	gateways := NewGatewayIndex(krtopts, controllerNames, envoyControllerName, policies, kubeRawGateways, kubeRawListenerSets, gatewayClasses, namespaces, gatewayForDeployerTransformationFunc, gatewayForEnvoyTransformationFunc)
