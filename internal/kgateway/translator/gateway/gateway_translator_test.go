...
func TestBasic(t *testing.T) {
	...
	t.Run("HTTPListenerPolicy access logging with filters", func(t *testing.T) {
		test(t, translatorTestCase{
			inputFile:  "httplistenerpolicy/access-logging-with-filters.yaml",
			outputFile: "httplistenerpolicy/access-logging-with-filters.yaml",
			gwNN: types.NamespacedName{
				Namespace: "default",
				Name:      "example-gateway",
			},
